...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown" style="margin-left: 500px;">
              <ul class="navbar-nav">
                <li class="nav-item" style="width: 200px;">
                  <a class="nav-link" href="customer_home.php" style="color: black; width: fit-content;">Scan Product<span class="sr-only">(current)</span></a>
                </li>
                ...
                <li class="nav-item active" style="width: 200px;">
                    <a class="nav-link" href="customer_account.php" style="color: black; font-weight: bold; width: fit-content;">My Account</a>
                  </li>
    ...
    <div id="wrap_cust">
        <form method="post" id="login">
          <?php 
            $sql = "SELECT * from customer where cust_id=\"".$_SESSION['user_id']."\";";
            $conn = connect();
          ...
          ?>
            ...
            <input type="text" name="type" id="type" placeholder="Customer" required><br>
        </form>
    </div>
